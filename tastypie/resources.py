...
class Resource(object):
    ...
    def base_urls(self):
        ...
        """
        #if not self._meta.api_name:
        #    return [
        #        url(r"^%s$" % trailing_slash(), self.wrap_view('dispatch_list'), name="api_dispatch_list"),
        #        url(r"^/schema%s$" % trailing_slash(), self.wrap_view('get_schema'), name="api_get_schema"),
        #        url(r"^/set/(?P<%s_list>\w[\w/;-]*)%s$" % (self._meta.detail_uri_name, trailing_slash()), self.wrap_view('get_multiple'), name="api_get_multiple"),
        #        url(r"^/(?P<%s>\w[\w/-]*)%s$" % (self._meta.detail_uri_name, trailing_slash()), self.wrap_view('dispatch_detail'), name="api_dispatch_detail"),
        #    ]
        return [
